...
public class Test_FC_app_CurrentUse_ScriptBasic_AppiumPython_auto extends Test_FC_app_core {
    @Test
...
//        selectDevice();
    ...
    public void test060_checkAppScript() {
        dp.waitByTimeOut(1000);
        dp.assertEqual("demo.zip", dp.getValueOf("currentUse_UI_Automator_uploadedname"));
