...
public class Test_checklist_automation {
	...
	public void test010_runCalabashSingle() {
        ...
        dp.waitByTimeOut(2000);
        //显示五种框架
//        dp.assertEqual("Compatibility",dp.getValueOf("Compatibility_icon"));
        dp.assertEqual("Appium + Python",dp.getValueOf("AppiumPython_icon"));
        dp.assertEqual("Calabash",dp.getValueOf("Calabash_icon"));
        dp.assertEqual("UI Automator",dp.getValueOf("UIAutomator_icon"));
        dp.assertEqual("Lettuce",dp.getValueOf("Lettuce_icon"));
...
//        dp.assertEqual("Compatibility",dp.getValueOf("Compatibility_icon"));
    ...
    public void test040_runAppiumPythonSingle(){
        ...
        dp.waitByTimeOut(2000);
        dp.select_scripts("Python-掌上生活-安卓脚本.zip");
        dp.waitByTimeOut(1000);
        dp.clickOn("Apps_StartAutomation_AppiumPython_SelectScript_NextButton");
        dp.automationSelectDevice_selectOneAvailableDevice(1); //选择一台可用设备
        dp.waitByTimeOut(1000);
        dp.clickOn("Apps_StartAutomation_AppiumPython_SelectDevice_NextButton");
        dp.waitByTimeOut(2000);
        dp.clickOn("Run_button");
        dp.waitByTimeOut(2000);
        dp.clickOn("close_button");
